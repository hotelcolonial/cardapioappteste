...
const DishesPage = () => {
  ...
  const { data: menuByType } = useGetMenuByTypeQuery({ menuTypeId: 2 });
  ...
  return (
    <div className="font-raleway py-10 lg:py-0">
      <div className="flex justify-between items-center pb-2">
        <h1 className="text-3xl font-black text-primary-green">Pratos</h1>
        <LanguageSelector />
      </div>
      ...
      <div className="grid xl:w-2/3 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {dishes.map((dish, index) => (
          <div
            ...
            key={index}
          >
            <Link href={`/admin/dashboard/menu/dishes/${dish.id}`}>
